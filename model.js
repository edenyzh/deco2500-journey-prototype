...
const MINUTE=60000,DURATION=180000,LATE_TOLERANCE_MINUTES=5;
...
function filterRoutes(routes,expected){return expected==null?routes:routes.filter(route=>route.etaMs<=expected+LATE_TOLERANCE_MINUTES*MINUTE);}
...
const api={LOCATIONS,COVERAGE,RIDES,FINAL_WALKS,MINUTE,DURATION,LATE_TOLERANCE_MINUTES,limits,validExpected,filterRoutes,createModel};if(typeof module!=='undefined')module.exports=api;else root.JourneyModel=api;
